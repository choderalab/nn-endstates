...
python eq.py lig01.solvent.system.xml lig01.solvent.positions.npz 0 100 10 lig01.solvent.eq.positions.npz 
...
#python eq_ANI.py lig01.vacuum.system.xml lig01.solvent.system.xml lig01.vacuum.topology.pkl lig01.solvent.topology.pkl lig01.solvent.positions.npz 0 100 lig01.solvent.eq_ani.positions.npz
